...
public class Spooler extends Thread {
	...
	protected Formule impressionTimeOfSize = null;
	 ...
	 *
	 * @param port
	 *            le port de communication avec le spooler
	 */
	 ...
	 *
	 * @param file
	 *            le fichier à insérer dans le spooler.
	 */
	...
	/**
	 * fixe la durée d'impression d'un job en fonction de sa taille et d'un
	 ...
	 */
	private int duree(int size) {
		return Math.max(100, 10 * size);
	}
	 ...
	 *
	 * @param f
	 *            la forumule de calcul du temps d'impression
	 */
	public void impressionTimeOfSize(Formule f) {
		impressionTimeOfSize = f;
	}
	 ...
	 */
	public synchronized int nbFileSpooled() {
		return spool.size();
	}
