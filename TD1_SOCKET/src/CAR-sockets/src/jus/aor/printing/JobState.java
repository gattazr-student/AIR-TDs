...
public class JobState implements Serializable {
	...
	private static class State implements Serializable {
		 ...
		 * 
		 * @param key
		 *            la représentation textuelle de la clé du job
		 * @param rang
		 *            le ranh du job
		 * @param delai
		 *            le délai
		 ...
		 *            sa taille
		 */
		public State(String key, int rang, long delai, int size) {
			this.key = key;
			this.rang = rang;
			this.delai = delai;
			this.size = size;
		...
		public String toString() {
			return key + "(rang=" + rang + ", delai=" + delai + ", size=" + size + ")";
		}
	}
	 ...
	 *            le JobPrint
	 * @param rang
	 *            le rang de ce job dans le spooler
	 * @param delai
	 *            le délai d'attente avant impression.
	 */
